...
namespace IPAddressRange.Test
{
    ...
    public class IPAddressRangeTest
    {
        ...
        {
            var range = new NetTools.IPAddressRange();
        ...
        {
            var range = new NetTools.IPAddressRange(IPAddress.Parse("192.168.0.88"));
            range.Begin.AddressFamily.Is(AddressFamily.InterNetwork);
        ...
        {
            var range = new NetTools.IPAddressRange(IPAddress.Parse("192.168.0.80"), 24);
            range.Begin.AddressFamily.Is(AddressFamily.InterNetwork);
        ...
        {
            var range = NetTools.IPAddressRange.Parse("192.168.60.13");
            range.Begin.AddressFamily.Is(AddressFamily.InterNetwork);
        ...
        {
            var range = NetTools.IPAddressRange.Parse("219.165.64.0/19");
            range.Begin.AddressFamily.Is(AddressFamily.InterNetwork);
        ...
        {
            var range = NetTools.IPAddressRange.Parse("219.165.64.73/32");
            range.Begin.AddressFamily.Is(AddressFamily.InterNetwork);
        ...
        {
            var range = NetTools.IPAddressRange.Parse("192.168.1.0/255.255.255.0");
            range.Begin.AddressFamily.Is(AddressFamily.InterNetwork);
        ...
        {
            var range = NetTools.IPAddressRange.Parse("192.168.60.26-192.168.60.37");
            range.Begin.AddressFamily.Is(AddressFamily.InterNetwork);
        ...
        {
            var fullRangeIPv6 = NetTools.IPAddressRange.Parse("::-fff:ffff:ffff:ffff:ffff:ffff:ffff:ffff");
            fullRangeIPv6.Contains(NetTools.IPAddressRange.Parse("192.168.0.0/24")).Is(false);

            var fullRangeIPv4 = NetTools.IPAddressRange.Parse("0.0.0.0-255.255.255.255");
            fullRangeIPv4.Contains(NetTools.IPAddressRange.Parse("::1-::2")).Is(false);
        }
        ...
        {
            var range = NetTools.IPAddressRange.Parse("192.168.60.26-192.168.60.37");
            var range1_same = NetTools.IPAddressRange.Parse("192.168.60.26-192.168.60.37");
            var range2_samestart = NetTools.IPAddressRange.Parse("192.168.60.26-192.168.60.30");
            var range3_sameend = NetTools.IPAddressRange.Parse("192.168.60.36-192.168.60.37");
            var range4_subset = NetTools.IPAddressRange.Parse("192.168.60.29-192.168.60.32");
        ...
        {
            var range = NetTools.IPAddressRange.Parse("192.168.60.29-192.168.60.32");
            var range1_overLeft = NetTools.IPAddressRange.Parse("192.168.60.26-192.168.70.1");
            var range2_overRight = NetTools.IPAddressRange.Parse("192.168.50.1-192.168.60.37");
            var range3_outOfLeft = NetTools.IPAddressRange.Parse("192.168.50.30-192.168.50.31");
            var range4_outOfRight = NetTools.IPAddressRange.Parse("192.168.70.30-192.168.70.31");
        ...
        public void ContainsTest_IPv6()
        {
            ...
            range = NetTools.IPAddressRange.Parse("::/0");
        ...
        {
            var range = NetTools.IPAddressRange.Parse("FE80::%eth0/10");
        ...
        private static void ContainsTest_RewriteProperties_IPv4(NetTools.IPAddressRange range)
        {
        ...
        private static void ContainsTest_RewriteProperties_IPv6(NetTools.IPAddressRange range)
        {
        ...
        public void ContainsTest_RewriteProperties_BeginIsEnd()
        {
            ...
            AssertEx.Throws<InvalidOperationException>(() =>
            {
                new NetTools.IPAddressRange { Begin = endIPv4, End = beginIPv4 }
                    .Contains(IPAddress.Parse("192.168.60.25"));
            ...
            AssertEx.Throws<InvalidOperationException>(() =>
            {
                new NetTools.IPAddressRange { Begin = endIPv6, End = beginIPv6 }
                    .Contains(IPAddress.Parse("192.168.60.25"));
            }).Message.Is("Begin must be smaller than the End");
        }
        ...
        {
            var range = NetTools.IPAddressRange.Parse("fe80::/10");
            var range1_same = NetTools.IPAddressRange.Parse("fe80::/10");
            var range2_samestart = NetTools.IPAddressRange.Parse("fe80::-fe80::d503:4ee:3882:c586");
            var range3_sameend = NetTools.IPAddressRange.Parse("fe80::d503:4ee:3882:c586-febf:ffff:ffff:ffff:ffff:ffff:ffff:ffff");
            var range4_subset = NetTools.IPAddressRange.Parse("fe80::d503:4ee:3882:c586-fe80::d504:4ee:3882:c586");
        ...
        {
            var range = NetTools.IPAddressRange.Parse("fe80::d503:4ee:3882:c586-fe80::d504:4ee:3882:c586");
            var range1_overLeft = NetTools.IPAddressRange.Parse("fe80::d502:4ee:3882:c586-fe80::d503:4ee:3882:c586");
            var range2_overRight = NetTools.IPAddressRange.Parse("fe80::d503:4ef:3882:c586-fe80::d505:4ee:3882:c586");
            var range3_outOfLeft = NetTools.IPAddressRange.Parse("fe80::d501:4ee:3882:c586-fe80::d502:4ee:3882:c586");
            var range4_outOfRight = NetTools.IPAddressRange.Parse("fe80::d505:4ee:3882:c586-fe80::d506:4ee:3882:c586");
        ...
        {
            var range = NetTools.IPAddressRange.Parse("::ffff:192.168.10.20-::ffff:192.168.11.20");
            ...
            var range1_overLeft = NetTools.IPAddressRange.Parse("::ffff:192.168.10.19-::ffff:192.168.10.21");
            var range2_overRight = NetTools.IPAddressRange.Parse("::ffff:192.168.11.19-::ffff:192.168.11.21");
            var range3_outOfLeft = NetTools.IPAddressRange.Parse("::ffff:192.168.10.18-::ffff:192.168.10.19");
            var range4_outOfRight = NetTools.IPAddressRange.Parse("::ffff:192.168.11.21-::ffff:192.168.11.22");
            var range5_justInside = NetTools.IPAddressRange.Parse("::ffff:192.168.10.20-::ffff:192.168.11.20");
            range.Contains(range1_overLeft).Is(false);
            range.Contains(range2_overRight).Is(false);
            range.Contains(range3_outOfLeft).Is(false);
            range.Contains(range4_outOfRight).Is(false);
        ...
        {
            var range = new NetTools.IPAddressRange(IPAddress.Parse("192.168.75.23"), NetTools.IPAddressRange.SubnetMaskLength(IPAddress.Parse("255.255.254.0")));
        ...
        public void SubnetMaskLengthTest_Invalid()
        {
            AssertEx.Throws<ArgumentException>(() =>
                new NetTools.IPAddressRange(IPAddress.Parse("192.168.75.23"), NetTools.IPAddressRange.SubnetMaskLength(IPAddress.Parse("255.255.54.0"))));
        }

        [TestMethod]
        public void Enumerate_IPv4()
        {
            var ips = NetTools.IPAddressRange.Parse("192.168.60.253-192.168.61.2").AsEnumerable().ToArray();
        ...
        {
            var ips = NetTools.IPAddressRange.Parse("fe80::d503:4ee:3882:c586/120").AsEnumerable().ToArray();
            ips.Length.Is(256);
        ...
        {
            foreach (var ip in NetTools.IPAddressRange.Parse("192.168.60.2"))
            {
        ...
        public void ToString_Output()
        {
            TestContext.Run((string input, string expected) =>
            {
                ...
                var output = NetTools.IPAddressRange.Parse(input).ToString();
                Console.WriteLine("  Result: \"{0}\"", output);
                output.Is(expected);

                var parsed = NetTools.IPAddressRange.Parse(output).ToString();
        ...
        public void GetPrefixLength_Success()
        {
            ...
            {
                Console.WriteLine("TestCase: \"{0}\", Expected: \"{1}\"", input, expected);
                var output = NetTools.IPAddressRange.Parse(input).GetPrefixLength();
                Console.WriteLine("  Result: \"{0}\"", output);
                output.Is(expected);
            });
        }
        ...
        public void GetPrefixLength_Failures()
        {
            TestContext.Run((string input, Type expectedException) =>
            {
                ...
                try
                {
                    NetTools.IPAddressRange.Parse(input).GetPrefixLength();
        ...
        public void ToCidrString_Output()
        {
            ...
            {
                Console.WriteLine("TestCase: \"{0}\", Expected: \"{1}\"", input, expected);
                var output = NetTools.IPAddressRange.Parse(input).ToCidrString();
                Console.WriteLine("  Result: \"{0}\"", output);
                output.Is(expected);
            });
        }
        ...
        public void ToCidrString_ThrowsOnNonCidr()
        {
            TestContext.Run((string input, Type expectedException) =>
            {
                ...
                try
                {
                    NetTools.IPAddressRange.Parse(input).ToCidrString();
                    Assert.Fail("Expected exception of type {0} to be thrown for input \"{1}\"", expectedException.Name, input);
                }
                catch (AssertFailedException)
                {
        ...
        public void GetHashCode_SameRange_HashCodesAreSame()
        {
            TestContext.Run((string input) =>
            {
                ...
                var range1 = NetTools.IPAddressRange.Parse(input);
                var range2 = NetTools.IPAddressRange.Parse(input);
        ...
        public void GetHashCode_DifferentRanges_HashCodesAreDifferent()
        {
            TestContext.Run((string input1, string input2) =>
            {
                ...
                var range1 = NetTools.IPAddressRange.Parse(input1);
                var range2 = NetTools.IPAddressRange.Parse(input2);
        ...
        {
            var range1 = NetTools.IPAddressRange.Parse("192.168.0.0/24");
            var range2 = default(NetTools.IPAddressRange);
            range1.Equals(range2).IsFalse();
        }
        ...
        {
            var ipAddressRange = NetTools.IPAddressRange.Parse("fe80::0000:0000-fe80::0100:0001");
